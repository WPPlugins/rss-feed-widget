...
Tags: rss, feed, facebook, slider, image, widget, page, techcrucnh, news, updates, aggregator, slidehow, feedly
...
3. Output - Text Only
4. Output - Image Only
5. New Feature - Add Images to RSS Feeds & Select Styles
6. A style implemented
7. Chameleon plugin compatibility
8. Another style implemented
